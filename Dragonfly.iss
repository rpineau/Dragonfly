...
#define MyAppName "Dragonfly X2 Plugin"
...
AppId={{15449D16-7042-4AAE-B2C3-2132C6AB5249}
AppName={#MyAppName}
...
Source: "Dragonfly.ui";                                 DestDir: "{app}\Plugins\DomePlugIns"; Flags: ignoreversion
Source: "Lunatico2.png";                                DestDir: "{app}\Plugins\DomePlugIns"; Flags: ignoreversion
; 64 bits
...
Source: "Dragonfly.ui";                                 DestDir: "{app}\Plugins64\DomePlugIns"; Flags: ignoreversion; Check: DirExists(ExpandConstant('{app}\Plugins64\DomePlugIns'))
Source: "Lunatico2.png";                                DestDir: "{app}\Plugins64\DomePlugIns"; Flags: ignoreversion; Check: DirExists(ExpandConstant('{app}\Plugins64\DomePlugIns'))
