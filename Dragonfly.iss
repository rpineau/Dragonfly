...
#define MyAppName "Dragonfly X2 Driver"
...
OutputBaseFilename=Dragonfly_X2_Installer
...
Source: "domelist Dragonfly.txt";                    DestDir: "{app}\Miscellaneous Files"; Flags: ignoreversion
Source: "domelist Dragonfly.txt";                    DestDir: "{app}\Miscellaneous Files"; Flags: ignoreversion; DestName: "domelist64 Dragonfly.txt"
; 32 bits
Source: "libDragonfly\Win32\Release\libDragonfly.dll";    DestDir: "{app}\Plugins\DomePlugIns"; Flags: ignoreversion
Source: "libDragonfly\Win32\Release\Dragonfly.ui";    DestDir: "{app}\Plugins\DomePlugIns"; Flags: ignoreversion
Source: "libDragonfly\Win32\Release\Lunatico2.png";    DestDir: "{app}\Plugins\DomePlugIns"; Flags: ignoreversion
; 64 bits
Source: "libDragonfly\x64\Release\libDragonfly.dll";      DestDir: "{app}\Plugins64\DomePlugIns"; Flags: ignoreversion; Check: DirExists(ExpandConstant('{app}\Plugins64\DomePlugIns'))
Source: "libDragonfly\x64\Release\Dragonfly.ui";      DestDir: "{app}\Plugins64\DomePlugIns"; Flags: ignoreversion; Check: DirExists(ExpandConstant('{app}\Plugins64\DomePlugIns'))
Source: "libDragonfly\x64\Release\Lunatico2.png";      DestDir: "{app}\Plugins64\DomePlugIns"; Flags: ignoreversion; Check: DirExists(ExpandConstant('{app}\Plugins64\DomePlugIns'))
